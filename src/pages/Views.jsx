...
const Views = () => {
  ...
  return (
    <>
      ...
      <div className="this-vio">
        ...
        <div className="video-js vjs-16-9 !w-full vjs-big-play-centered vjs-paused vjs-controls-enabled vjs-touch-enabled vjs-workinghover vjs-v8 vjs-user-active vjs_video_554-dimensions" id="vjs_video_554">
          <iframe className="this-ifrm"
            ref={iframeRef}
            src="https://player.vimeo.com/video/1053219469?byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
            frameBorder="0"
      ...
      {/* video */}
      <div className="w-full lg:px-10 poti-17 pt-28 grid grid-flow-cols grid-cols-1 lg:grid-cols-2 gap-y-8 justify-center items-end">
        <PackageCard
          title="Pacote Basico"
          likes="1.000"
          oldPrice="19.00"
